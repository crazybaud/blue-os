...
| Plugin | Version | Author | License | Source |
|---|---|---|---|---|
| QuickAdd | 2.22.0 | Christian B. B. Houmann | MIT | https://github.com/chhoumann/quickadd |
...
corresponding source for the exact version is available from the upstream
repository at the tag matching the bundled version; the full GPL-3.0 text
ships in `sample/vault/.obsidian/plugins/obsidian-front-matter-title-plugin/LICENSE`.

The Blue OS framework itself (templates, scripts, sample content, installer)
